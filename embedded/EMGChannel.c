...
{
    return me->itsCalculateColor.red << 16 + me->itsCalculateColor.green << 8 + me->its - CalculateColor.blue;
}
...
struct EMGSensorDeviceDriver* EMGChannel_getItsEMGSensorDeviceDriver(const EMGChan - nel * const me)
{
