...
void TokenizerSyncSingleReceptor_eventDispatch(TokenizerSyncSingleReceptor* Event e)
{
...
TokenizerSyncSingleReceptor* TokenizerSyncSingleReceptor_Create(void)
{
    ...
    if (me != NULL) { TokenizerSyncSingleReceptor_Init(me); }
    return me;
}

void TokenizerSyncSingleReceptor_Destroy(TokenizerSyncSingleReceptor* const me)
{
    if (me != NULL) { TokenizerSyncSingleReceptor_Cleanup(me); }
    free(me);
}
