...
/*
 * process the evDigit event, passing the character c as a parameter
 */
...
void
TokenizerMultiReceptor_enter_ProcessingFractionalPart(TokenizerMultiReceptor* const me)
{
}
...
void TokenizerMultiReceptor_exit_ProcessingFractionalPart(TokenizerMultiReceptor* me) {}

const void TokenizerMultiReceptor_exit_ProcessingWholePart(TokenizerMultiReceptor* const me) {}
