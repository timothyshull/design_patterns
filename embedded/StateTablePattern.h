...
typedef enum TSTATETYPE {
    NULL_STATE,
    NONUMBER_STATE, GN_PROCESSINGWHOLEPART_STATE, GN_PROCESSINGFRACTIONALPART_STATE
} TSTATETYPE;

/* This action pointer accepts the me object pointer and no other parameters. */ typedef void (* ActionPtr0)(void*);
...
typedef struct ap {
    int nParams; /* 0 or 1 in this case */ union {
        ActionPtr0 a0;
        ActionPtr1 a1;
    } aPtr;
} ActionType;
...
/* This function returns an int that is treated as a Boolean (0 == FALSE) and, if present, is used to determine whether or not the transition is taken. Note that this function takes no parameters (other than the object me pointer). */
