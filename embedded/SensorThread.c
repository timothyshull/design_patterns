...
/*
 * updateData runs every period of the sensor
 * thread and calls the getXXData() function of each of
 * its sensors, then uses a random number generator to
 * decide which data should be published to the GasDataQueue.
 */
